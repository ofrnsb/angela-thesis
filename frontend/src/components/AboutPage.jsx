      ...
      <div className='about-content'>
        ...
        <section className='about-section'>
          ...
          <div className='explanation-box'>
            <p>
              <strong>Smart Contract</strong> adalah program komputer yang
              berjalan di blockchain yang secara otomatis menjalankan perjanjian
              atau kontrak ketika kondisi tertentu terpenuhi. Bayangkan seperti
              mesin penjual otomatis: Anda memasukkan uang, memilih produk, dan
              mesin secara otomatis memberikan produk tersebut tanpa perlu
              campur tangan manusia.
            </p>
            <div className='analogy-box'>
              <h3>Analogi Sederhana:</h3>
              <p>
                Jika perjanjian tradisional memerlukan notaris, saksi, dan
                dokumen kertas yang bisa hilang atau diubah, smart contract
                adalah perjanjian digital yang:
              </p>
              <ul>
                <li>
                  <strong>Tidak bisa diubah</strong> - Setelah dibuat, tidak
                  bisa dimanipulasi
                </li>
                <li>
                  <strong>Otomatis</strong> - Menjalankan sendiri tanpa perlu
                  manusia
                </li>
                <li>
                  <strong>Transparan</strong> - Semua orang bisa melihat (tapi
                  tidak bisa mengubah)
                </li>
                <li>
                  <strong>Terpercaya</strong> - Tidak ada pihak ketiga yang bisa
                  curang
                </li>
              </ul>
            </div>
          ...
          <div className='explanation-box'>
            ...
            <div className='use-cases'>
              <div className='use-case-card'>
                ...
                <p>Banyak platform trading menggunakan smart contract untuk:</p>
                <ul>
              ...
              <div className='use-case-card'>
                ...
                <p>Bank-bank besar mulai menggunakan smart contract untuk:</p>
                <ul>
              ...
              <div className='use-case-card'>
                ...
                <p>
                  Perusahaan seperti IBM, Microsoft, dan lainnya menggunakan
          ...
          <div className='explanation-box'>
            ...
            <div className='comparison'>
              <div className='comparison-card traditional'>
                ...
                <p className='disadvantage'>Lama, Mahal, Kurang transparan</p>
              </div>
              ...
              <div className='comparison-card smart'>
                ...
                <p className='advantage'>Cepat, Murah, Transparan</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className='about-section'>
          ...
          <div className='benefits-grid'>
            <div className='benefit-card'>
              ...
              <h3>Kecepatan</h3>
              <p>
                Transaksi bisa selesai dalam hitungan detik atau menit, bukan
                hari seperti sistem tradisional.
              </p>
            </div>
            ...
            <div className='benefit-card'>
              ...
              <h3>Biaya Rendah</h3>
              <p>
                Mengurangi biaya operasional karena tidak perlu banyak pegawai
            ...
            <div className='benefit-card'>
              ...
              <p>
                Data tersimpan di blockchain yang sangat sulit diretas atau
                dimanipulasi.
              </p>
            </div>
            ...
            <div className='benefit-card'>
              ...
              <h3>Transparansi</h3>
              <p>
                Semua transaksi tercatat dan bisa diverifikasi, mengurangi
                risiko korupsi atau penipuan.
              </p>
            </div>
            ...
            <div className='benefit-card'>
              ...
              <h3>Otomatisasi</h3>
              <p>
                Tidak perlu campur tangan manusia, mengurangi risiko human
                error.
              </p>
            </div>
            ...
            <div className='benefit-card'>
              ...
              <h3>Global</h3>
              <p>
                Bisa digunakan di mana saja di dunia, tidak terbatas geografis.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className='explanation-box'>
            ...
            <div className='feature-example'>
              ...
              <ul>
                ...
                <li>
                  Mengurangi saldo Anda dan menambah saldo penerima secara
                  otomatis
                </li>
                <li>
                  Mencatat transaksi di blockchain (tidak bisa dihapus atau
                  diubah)
                </li>
              </ul>
            </div>
            ...
            <div className='feature-example'>
              ...
              <p>Transfer ke bank lain juga otomatis melalui smart contract:</p>
              <ul>
            ...
            <div className='feature-example'>
              ...
              <p>Membeli token listrik, pulsa, atau produk digital lainnya:</p>
              <ul>
        ...
        <section className='about-section'>
          ...
          <div className='explanation-box'>
            <div className='future-box'>
              ...
              <ul>
                <li>
                  <strong>Bank Sentral di berbagai negara</strong> sedang
                  mengembangkan mata uang digital (CBDC) berbasis blockchain
                </li>
                <li>
                  <strong>Perusahaan teknologi besar</strong> seperti IBM,
                  Microsoft, dan Amazon sudah menggunakan blockchain untuk
                  berbagai layanan
                </li>
                <li>
                  <strong>Bank-bank internasional</strong> seperti JPMorgan,
                  HSBC, dan lainnya sudah mengimplementasikan smart contract
                </li>
                <li>
              ...
              <div className='quote-box'>
                <p className='quote'>
                  "Smart contract akan mengubah cara kita melakukan bisnis, sama
                  seperti internet mengubah cara kita berkomunikasi."
                </p>
                <p className='quote-author'>
                  - Para ahli teknologi dan keuangan
                </p>
              </div>
            </div>
          </div>
        ...
        <section className='about-section'>
          ...
          <div className='conclusion-box'>
            <p>
              Smart contract adalah teknologi revolusioner yang membawa
              transparansi, kecepatan, dan keamanan ke dalam sistem perbankan
              dan keuangan. Meskipun masih relatif baru, teknologi ini sudah
              digunakan oleh banyak institusi besar di dunia.
            </p>
            <p>
              Aplikasi ini adalah contoh sederhana bagaimana smart contract
              dapat digunakan untuk mengotomatisasi transaksi perbankan, membuat
              proses lebih cepat, lebih murah, dan lebih transparan.
            </p>
